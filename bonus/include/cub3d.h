...
/*   Updated: 2023/08/30 15:51:27 by rlarabi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				utils_reaplace(char *result, char *text, int number,
						char c);
...
void				step_rays_v(t_general *info, double *x_steps,
						double *y_steps, double beta);
double				calcule_projection(t_general *info);
void				calcule_of_wall(t_general *info, int i,
						t_coordinates *start);
